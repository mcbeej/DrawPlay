...
public class Cat {
	...
	//starts nose a little less than half from the middle
	private static final int NOSE_Y = HEAD_DIMENSIONS/12 * 4;
	private static final int NOSE_X = HEAD_DIMENSIONS/12 * 5;
